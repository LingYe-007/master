...
3) 针对当前联邦推荐系统落地困难的问题，本文构建了支持\textbf{异构设备协同}的\textbf{联邦论文推荐系统}。该系统采用\textbf{端云协同的异步聚合架构}以适配不同性能的终端设备，并集成了\textbf{本地差分隐私模块}，完成了联邦推荐系统的落地。
\par
}
