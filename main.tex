...
% 策略：\AtPageUpperLeft 原点在页顶左；\makebox[\paperwidth][c] 撑满整页使文字居中；
%       页眉线也用 eso-pic 绘制，保证奇偶页都相对纸张居中
\AddToShipoutPictureFG{%
  \ifnum\value{usefancyheader}=1
    \AtPageUpperLeft{%
      \put(\dimexpr0.5\paperwidth\relax,-\dimexpr12mm\relax){\makebox(0,0)[c]{\headerfont\ifodd\value{page}\leftmark\else 西北大学硕士学位论文\fi}}%
      \put(0,-\dimexpr18mm\relax){\rule{\paperwidth}{0.4pt}}%
    }%
  \fi
}
